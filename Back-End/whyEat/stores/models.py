...
class Store_score(models.Model): # Score
    objects = models.Manager()
    store = models.ForeignKey(Store, to_field='store_id', on_delete=models.CASCADE,related_name='review')
...
class Store_menu(models.Model):
    objects = models.Manager()
    store = models.ForeignKey(Store, to_field='store_id', on_delete=models.CASCADE,related_name='menu') 
